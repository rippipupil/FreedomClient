# Mods de terceros integrados

FreedomClient incluye sin modificar los siguientes mods (Jar-in-Jar de Fabric). Cada uno conserva su licencia;
el código fuente está disponible en los enlaces.

| Mod | Autor | Licencia | Código fuente |
|---|---|---|---|
| Fabric API | FabricMC | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | https://github.com/FabricMC/fabric-api |
| Sodium | CaffeineMC (JellySquid) | [PolyForm Shield 1.0.0](https://polyformproject.org/licenses/shield/1.0.0) | https://github.com/CaffeineMC/sodium |
